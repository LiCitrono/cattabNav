...
export default function Home() {
  ...
  return (
    <main className="relative w-full h-screen overflow-hidden text-white font-sans">
      ...
      <a href="https://github.com/kayaladream/cattab" target="_blank" rel="noopener noreferrer" className="absolute top-6 right-6 z-50 text-white/70 hover:text-white transition-all hover:scale-110 drop-shadow-md">
